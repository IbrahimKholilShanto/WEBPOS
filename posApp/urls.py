...
urlpatterns = [
    ...
    path('purchase', views.purchase, name="purchaseProducts-page"),
    path('save_purchase', views.save_purchase, name="save_purchase"),
    # path('save_purchase', views.save_supplier, name="save-purchase-page"),
    path('delete_purchase', views.delete_purchase, name="delete_purchase"),

    path('supplier', views.supplier, name="supplier-page"),
    path('manage_supplier', views.manage_supplier, name="manage_supplier-page"),
